...
Once an `outForest` object is fitted with option `allow_predictions`, it can be used to find and replace outliers in new data without refitting. Note that random forests can be huge, so use this option with care.
