...
The outlier score of the $i$-th observed value $x_{ij}$ of variable $j$ is defined as 
$$
...
We first generate a data set with two truely multivariate outliers.
...
- Use less trees, e.g. by setting `num.trees = 50`. Don't use a too low value to prevent out-of-bag predictions to be missing.
