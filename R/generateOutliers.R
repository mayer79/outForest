...
#' @param sd_factor Each outlier is generated by shifting the original value by a realisation of a normal random variable with \code{sd_factor} times the original sample standard deviation.
